...
const NAV_ITEMS = [
  ...
  { key: 'products', href: 'products.html', icon: '&#128230;', label: 'Produk', module: 'products' },
  { key: 'categories', href: 'categories.html', icon: '&#128193;', label: 'Kategori', module: 'categories' },
  { key: 'inventory', href: 'inventory.html', icon: '&#128202;', label: 'Inventory', module: 'inventory' },
  { key: 'suppliers', href: 'suppliers.html', icon: '&#128666;', label: 'Supplier', module: 'suppliers' },
  { key: 'purchase-orders', href: 'purchase-orders.html', icon: '&#128203;', label: 'Purchase Order', module: 'purchase_orders' },
  { key: 'customers', href: 'customers.html', icon: '&#128101;', label: 'Pelanggan', module: 'customers' },
  { key: 'promotions', href: 'promotions.html', icon: '&#127991;', label: 'Promosi', module: 'promotions' },
